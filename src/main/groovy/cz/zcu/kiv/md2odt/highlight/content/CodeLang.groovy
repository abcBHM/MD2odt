...
enum CodeLang {
    ...
    COQ("CoqLexer", "coq"),
    CRYPTOL("LiterateCryptolLexer", "lcry", "literate-cryptol", "lcryptol", "cryptol"),
    CRYSTAL("CrystalLexer", "cr", "crystal"),
    ...
    ELM("ElmLexer", "elm"),
    ELIXIR_CONSOLE("ElixirConsoleLexer", "iex", "elixirconsole"),
